...
def do_zip_update():
    ...
    if success:
        ...
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/hackelite01/MBomb.git")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/hackelite01/MBomb.git HEAD")
    sys.exit()
...
def check_for_updates():
    ...
    fver = requests.get(
            "https://raw.githubusercontent.com/hackelite01/MBomb/master/.version"
            ).text.strip()
    if fver != __VERSION__:
...
def notifyen():
    try:
        noti = requests.get(
            "https://raw.githubusercontent.com/hackelite01/MBomb/master/.notify"
            ).text.upper()
        if len(noti) > 10:
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("MBomb was created by hackelite01")
...
__CONTRIBUTORS__ = ['hackelite01', 'Mayank']
